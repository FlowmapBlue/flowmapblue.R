...
This is a [Flowmap.blue](https://flowmap.blue) widget for R.
...
As an alternative, you may also consider using R to populate a spreadsheet for publishing on [Flowmap.blue](https://flowmap.blue)
